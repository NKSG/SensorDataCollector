...
@interface StatsViewController : UIViewController<UIAccelerometerDelegate,CLLocationManagerDelegate>{
...
@property (nonatomic, retain) IBOutlet UILabel *heandingInfo;
